...
> **데이터 파일은 본 저장소에 포함되어 있지 않습니다.** 용량 문제로 별도 업로드하지 않았으며, 노트북의 데이터 다운로드 셀('kagglehub.dataset_download(...)')을 실행하면 위 Kaggle 링크의 데이터셋이 자동으로 다운로드됩니다.
...
학습/평가 과정에서 아래와 같은 시각화 자료가 생성됩니다(노트북 실행 시 생성, 발표자료 활용 목적):
